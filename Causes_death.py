...
table3 = pd.crosstab(adjusted_data['Age-adjusted Death Rate'], adjusted_data['Year'])

# Percentage using the crosstab()
proportion4 = pd.crosstab(adjusted_data['Age-adjusted Death Rate'], adjusted_data['Cause Name'], normalize=True)
proportion5 = pd.crosstab(adjusted_data['Deaths'], adjusted_data['Cause Name'], normalize=True)
